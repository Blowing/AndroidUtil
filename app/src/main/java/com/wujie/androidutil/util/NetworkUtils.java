...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        Utils.getApp().startActivity(new Intent(Settings.ACTION_WIRELESS_SETTINGS).setFlags
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager)Utils.getApp().getSystemService(CONNECTIVITY_SERVICE))
     ...
     * <p>ping的ip为阿里巴巴公共ip：223.5.5.5</p>判断网络是否可用
     * <p>需添加权限 {@code <uses-permission android:name="android.permission.INTERNET"/>}</p>
     * <p>需要异步ping，如果ping不通就说明网络不可用</p>
     ...
     * @return
     */
    public static boolean getDataEndabled() {
    ...
    public static void setDataEnabled(final boolean enabled) {
        TelephonyManager tm = (TelephonyManager) Utils.getApp().getSystemService(Context
                .TELEPHONY_SERVICE);
        try {
            Method setMObileDataEnabledMethod = tm.getClass().getMethod("setDataEnabled", boolean
                    .class);
     ...
     * @param isWifiEnabled
     */
    public static void setWifiEnabled(boolean isWifiEnabled) {
        WifiManager wifiManager = (WifiManager) Utils.getApp().getSystemService(Context
                .WIFI_SERVICE);
        if (isWifiEnabled) {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) Utils.getApp().getSystemService(
    ...
    private static final int NETWORK_TYPE_SCDMA = 17;
    ...
    public static String getIPAddress(final boolean usdIpV4) {
        try {
